...
class FisikController extends Controller
{
    ...
    {
        return view('fisik.create', ['fisik' => new Fisik]);
    }
    ...
    {
        return view('fisik.edit', ['fisik' => $fisik]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(FisikRequest $request, Fisik $fisik)
    {
        $fisik->update($request->all());
        return redirect('/fisik/edit');
    }
