...
<div class="row">
	...
	<div class="col-md-3">
		...
		<div class="form-group{{ $errors->has('video_url') ? ' has-error' : '' }}">
			...
			@if ($post->video_url)
				<iframe width="100%" height="200" src="https://www.youtube.com/embed/{{ $post->video_url }}" frameborder="0" allowfullscreen></iframe>
			@endif

			{{ Form::text('video_url', $post->video_url, ['class' => 'form-control', 'placeholder' => 'Video URL']) }}
