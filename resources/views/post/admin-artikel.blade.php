...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading"> MANAGE ARTIKEL </div>
        <div class="panel-body">

            {!! Form::open(['method' => 'get', 'class' => 'form-inline']) !!}
                {!! Form::text('q', request('q'), ['class' => 'form-control', 'placeholder' => 'Search Artikel']) !!}
                <button type="submit" name="search" class="btn btn-default"><i class="fa fa-search"></i> Search</button>

                <a href="/post/create?type=artikel" class="btn btn-primary">
